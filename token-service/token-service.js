...
async function associateTokenToAccount(tokenId, account, client) {  
  ...
  console.log(`NFT association with Account 3: ${transactionReceipt.status.toString()}\n`);
...
async function main() {  
  ...
  await mintToken(tokenId, supplyKey, 5, client);
  ...
  console.log(`NFT transfer: Treasury -> Account3: ${tokenTransferRx.status} \n`);

  /* TokenBalanceQuery was not working  */
